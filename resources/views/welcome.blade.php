...
<!-- Mirrored from www.annimexweb.com/items/avone/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jan 2026 02:47:47 GMT -->
<head>
...
<div class="page-wrapper">
                                        ...
                                        <li class="grid__item large-up--one-whole">
                                            <ul class="grid">
                                                <li class="grid__item lvl-1 col-md-4 col-lg-4">
                                                    ...
                                                    <ul class="subLinks">
                                                      <li class="lvl-2"><a href="index-2.html" class="site-nav lvl-2">Home 01 <span class="lbl nm_label3">Popular</span></a></li>
                                                      ...
                                                      <li class="lvl-2"><a href="index-pottery-store.html" class="site-nav lvl-2">Pottery Store</a></li>
                                                      <li class="lvl-2"><a href="index-modern.html" class="site-nav lvl-2">Modern <span class="lbl nm_label2">New</span></a></li>
                                                    </ul>
                                                  </li>
                                                <li class="grid__item lvl-1 col-md-4 col-lg-4">
                                                	<a href="#" class="site-nav lvl-1 menu-title">Homepages</a>
                                                    <ul class="subLinks">
                                                        ...
                                                        <li class="lvl-2"><a href="index-yoga-shop.html" class="site-nav lvl-2">Yoga Shop</a></li>
                                                        <li class="lvl-2"><a href="index-wine-store.html" class="site-nav lvl-2">Wine Store</a></li>
                                                        <li class="lvl-2"><a href="index-plants.html" class="site-nav lvl-2">Plants <span class="lbl nm_label2">New</span></a></li>
                                                    </ul>
                                                </li>
                                                <li class="grid__item lvl-1 col-md-4 col-lg-4">
                                                	<a href="#" class="site-nav lvl-1 menu-title">Homeskin</a>
                                                    <ul class="subLinks">
                                                    	<li class="lvl-2"><a href="index-jewelry-store.html" class="site-nav lvl-2">Jewelry Store</a></li>
                                                        ...
                                                        <li class="lvl-2"><a href="index-christmas-1.html" class="site-nav lvl-2">Christmas 1</a></li>
                                                        <li class="lvl-2"><a href="index-christmas-2.html" class="site-nav lvl-2">Christmas 2</a></li>
                                                        <li class="lvl-2"><a href="index-bags-store.html" class="site-nav lvl-2">Bags Store</a></li>
                                                        <li class="lvl-2"><a href="index-digital-store.html" class="site-nav lvl-2">Digital Store</a></li>
                                                        <li class="lvl-2"><a href="index-beachwear.html" class="site-nav lvl-2">Beachwear</a></li>
                                                        <li class="lvl-2"><a href="index-bike-store.html" class="site-nav lvl-2">Bike Store</a></li>
                                                        <li class="lvl-2"><a href="index-kids-toy.html" class="site-nav lvl-2">Kids Toy <span class="lbl nm_label2">New</span></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
    ...
    <div class="mobile-nav-wrapper" role="navigation">
        ...
        <ul id="MobileNav" class="mobile-nav">
        	<li class="lvl1 parent megamenu"><a href="index-2.html">Home <i class="anm anm-plus-l"></i></a>
          <ul>
            <li><a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
              <ul>
              	<li><a href="index-2.html" class="site-nav">Home 01 <span class="lbl nm_label3">Popular</span></a></li>
                ...
                <li><a href="index-modern.html" class="site-nav">Modern <span class="lbl nm_label2">New</span></a></li>
              </ul>
            </li>
            <li><a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
              <ul>
                ...
                <li><a href="index-plants.html" class="site-nav">Plants <span class="lbl nm_label2">New</span></a></li>
              </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li class="lvl-2"><a href="index-bags-store.html" class="site-nav">Bags Store</a></li>
                    <li class="lvl-2"><a href="index-digital-store.html" class="site-nav">Digital Store</a></li>
                    <li class="lvl-2"><a href="index-beachwear.html" class="site-nav">Beachwear</a></li>
                    <li class="lvl-2"><a href="index-bike-store.html" class="site-nav">Bike Store</a></li>
                    <li class="lvl-2"><a href="index-kids-toy.html" class="site-nav lvl-2">Kids Toy <span class="lbl nm_label2">New</span></a></li>
                </ul>
            </li>
          </ul>
    ...
    <div id="page-content">
    	...
    	<div class="slideshow slideshow-wrapper">
        	<div class="home-slideshow">
                ...
                <div class="slide">
                	<div class="blur-up lazyload">
                        <img class="blur-up lazyload" data-src="assets/images/slideshow-banner/dome1-banner2.jpg" src="assets/images/slideshow-banner/dome1-banner2.jpg" alt="The Powerful Theme You can Trust" title="The Powerful Theme You can Trust" />
                ...
                <div class="productSlider grid-products">
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                ...
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product1-1.jpg" src="assets/images/product-images/product1-1.jpg" alt="" title="">
                                <!-- End hover image -->
                                <!-- product label -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="assets/images/product-images/product2.jpg" src="assets/images/product-images/product2.jpg" alt="" title="">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product2-1.jpg" src="assets/images/product-images/product2-1.jpg" alt="" title="">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="assets/images/product-images/product3.jpg" src="assets/images/product-images/product3.jpg" alt="" title="">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product3-1.jpg" src="assets/images/product-images/product3-1.jpg" alt="" title="">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                            <!--Product label-->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="assets/images/product-images/product8-1.jpg" src="assets/images/product-images/product8-1.jpg" alt="" title="">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product8.jpg" src="assets/images/product-images/product8.jpg" alt="" title="">
                                <!-- End hover image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="assets/images/product-images/product6.jpg" src="assets/images/product-images/product6.jpg" alt="" title="">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product6-1.jpg" src="assets/images/product-images/product6-1.jpg" alt="" title="">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
					...
					<div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="product-layout1.html" class="product-img">
                                <!-- image -->
                                <img class="primary blur-up lazyload" data-src="assets/images/product-images/product4.jpg" src="assets/images/product-images/product4.jpg" alt="" title="">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="assets/images/product-images/product4-1.jpg" src="assets/images/product-images/product4-1.jpg" alt="" title="">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                            <!--Product label-->
            	...
            	<div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 banner-item">
                        <div class="imgBanner-grid-item">
                            <div class="img">
                                <a href="collection-page.html" class="collection-grid-item__link">
                                    <img class="blur-up lazyload" data-src="assets/images/collection-banner/demo1-banr2.jpg" src="assets/images/collection-banner/demo1-banr2.jpg" alt="Cosmetic"/>
                                </a>
                            </div>
                            <div class="details center w-50">
                                <div class="inner">
...
<!-- Mirrored from www.annimexweb.com/items/avone/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jan 2026 02:50:55 GMT -->
</html>