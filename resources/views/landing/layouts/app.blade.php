...
<!-- Mirrored from keenthemes.com/metronic/tailwind/demo7/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 08:01:12 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta content="https://keenthemes.com/metronic/tailwind/demo7/" property="og:url" />
...
<body
                                        ...
                                        <div class="kt-menu-link flex items-center jistify-between gap-2">
                                            ...
                                            <div class="flex justify-end shrink-0">
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('') }}assets/landing/media/avatars/300-14.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('') }}assets/landing/media/avatars/300-12.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('') }}assets/landing/media/avatars/300-9.png" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="kt-menu-link flex justify-between gap-2">
                                                <div class="flex items-center gap-2.5">
                                                    <img alt="" class="rounded-full size-9 shrink-0"
                                                        src="{{ asset('') }}assets/landing/media/avatars/300-3.png" />
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-6.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-3.png" />
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-8.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-18.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-17.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-20.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="{{ asset('') }}assets/landing/media/avatars/300-21.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid gap-1">
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="{{ asset('') }}assets/landing/media/avatars/300-11.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    Jacob Jones
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="{{ asset('') }}assets/landing/media/avatars/300-5.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    TLeslie Alexander
    ...
    <script src="{{ asset('') }}assets/landing/vendors/ktui/ktui.min.js"></script>
    <script src="{{ asset('') }}assets/landing/vendors/apexcharts/apexcharts.min.js"></script>
    <script src="{{ asset('') }}assets/landing/js/widgets/general.js"></script>
    <script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
    @stack('js')
    <!-- End of Scripts -->
</body>

<!-- Mirrored from keenthemes.com/metronic/tailwind/demo7/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2026 08:04:31 GMT -->
