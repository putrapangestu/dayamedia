            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
              <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img" src='https://images.unsplash.com/photo-1557752281-0dcc70763e98?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                ...
                <div class="pr_detail">
                    <div class="product_description">
                        ...
                        <div class="product_price d-flex flex-column">
                            <small>Harga Buku</small>
                            <span class="price">Rp.100.000</span>
                        </div>
                        <div class="rating_wrap d-flex flex-column">
                            <small>Harga E-Book</small>
        	...
        	<div class="col-12">
            	<div class="tab-style3">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="Description-tab" data-bs-toggle="tab" href="#Description" role="tab" aria-controls="Description" aria-selected="true">Deskripsi</a>
                      	</li>
                      	<li class="nav-item">
                        	<a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab" href="#Additional-info" role="tab" aria-controls="Additional-info" aria-selected="false">Informasi Tambahan</a>
                      	</li>
                      	<li class="nav-item">
                        	<a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="#Reviews" role="tab" aria-controls="Reviews" aria-selected="false">Preview Buku</a>
                      	</li>
                    </ul>
