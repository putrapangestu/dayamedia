...
<div class="body-wrapper">
    <div class="container-fluid">
        <x-header-page
            title="Tambah Member"
            description="Halaman untuk menambahkan member baru"
            >
        </x-header-page>
        <div class="row">
            <div class="col-12">
                    ...
                    @csrf
                        <div class="form-sticky-header">
                            <div class="d-flex border-bottom p-4">
                                <div>
                                    <h5 class="m-0 p-0">Formulir Tambah Member</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="degree" name="degree" placeholder="S.Tr.Kom" value="{{ old('degree') }}">
                                        @error('degree')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="job" name="job" placeholder="Dosen" value="{{ old('job') }}">
                                        @error('job')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
