...
<div class="body-wrapper">
    <div class="container-fluid">
        <x-header-page
            title="Tambah Promo"
            description="Halaman untuk menambahkan promo baru"
            >
        </x-header-page>
        <div class="row">
            <div class="col-12">
                    ...
                    @csrf
                        <div class="form-sticky-header">
                            <div class="d-flex border-bottom p-4">
                                <div>
                                    <h5 class="m-0 p-0">Formulir Tambah Promo</h5>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="code" name="code" placeholder="Premium" value="{{ old('code') }}">
                                        @error('code')
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="percentage" name="percentage" placeholder="10" value="{{ old('percentage') }}">
                                        @error('percentage')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Premium" value="{{ old('quantity') }}">
                                        @error('quantity')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="start_date" name="start_date" placeholder="Premium" value="{{ old('start_date') }}">
                                        @error('start_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="end_date" name="end_date" placeholder="Premium" value="{{ old('end_date') }}">
                                        @error('end_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="book_ids[]" class="form-control select2-book" id="book_ids" multiple="multiple">
                                            @foreach($books as $book)
                                                <option value="{{ $book->id }}" {{ in_array($book->id, old('book_ids', [])) ? 'selected' : '' }}>{{ $book->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('book_ids')
                                            <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="description" rows="3" placeholder="Deskripsi Promo">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
