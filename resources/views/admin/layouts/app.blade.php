...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('') }}assets/dashboard/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css" />
...
<body class="link-sidebar">
    ...
    <div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      ...
      <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
        <ul class="mb-0">
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('') }}assets/dashboard/images/products/product-1.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('') }}assets/dashboard/images/products/product-2.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('') }}assets/dashboard/images/products/product-3.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
        ...
        <div class="align-bottom">
          ...
          <a href="{{ route('checkout') }}" class="btn btn-outline-primary w-100">Go to shopping cart</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="{{ asset('') }}assets/dashboard/js/theme/sidebarmenu.js"></script>
