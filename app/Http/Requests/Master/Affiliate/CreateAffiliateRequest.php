...
class CreateAffiliateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:affiliate_levels,name,NULL,id,deleted_at,NULL',
            'percentage' => 'required|numeric|min:0|max:100',
            'min_earning' => 'required|numeric|min:0|unique:affiliate_levels,min_earning,NULL,id,deleted_at,NULL',
